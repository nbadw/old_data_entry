	...
	public partial class Download1 : System.Web.UI.Page
	{
		...
		protected void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			if(txtyear.Text.Length!=0)
			{
				...
				{
					filterstringy1 += " AND SUBSTRING(DataBegins,1,4) <= '"+txtyear.Text+"' AND SUBSTRING(DataEnds,1,4) >= '"+txtyear.Text+"'";
					filterstringy2 += " AND SUBSTRING(Date,1,4)= '"+txtyear.Text+"'";
					filterstringy3 += " AND SUBSTRING(RecordingStartDate,1,4) <= '"+txtyear.Text+"' AND SUBSTRING(RecordingEndDate,1,4) >= '"+txtyear.Text+"'";
				}
					/*
					 * need to work on the else if part below, then apply
					 * filter to all datasets. Next need to reapply when 
					 * user clicks download button and then page is done
					 */
				...
				else if(txtyear.Text.Length==9)//range specified
				{
					...
					filterstringy1 += " AND ((SUBSTRING(DataBegins,1,4) >= "+strDataBegins+" AND SUBSTRING(DataEnds,1,4) <= "+strDataEnds+") OR (SUBSTRING(DataBegins,1,4) <= "+strDataEnds+" AND SUBSTRING(DataEnds,1,4) >= "+strDataEnds+") OR (SUBSTRING(DataBegins,1,4) <= "+strDataBegins+" AND SUBSTRING(DataEnds,1,4) >= "+strDataBegins+"))";
					filterstringy2 += " AND (SUBSTRING(Date,1,4) >= "+strDataBegins+" AND SUBSTRING(Date,1,4) <= "+strDataEnds+")";
					filterstringy3 += " AND ((SUBSTRING(RecordingStartDate,1,4) >= "+strDataBegins+" AND SUBSTRING(RecordingEndDate,1,4) <= "+strDataEnds+") OR (SUBSTRING(RecordingStartDate,1,4) <= "+strDataEnds+" AND SUBSTRING(RecordingEndDate,1,4) >= "+strDataEnds+") OR (SUBSTRING(RecordingStartDate,1,4) <= "+strDataBegins+" AND SUBSTRING(RecordingEndDate,1,4) >= "+strDataBegins+"))";					
			...
			#endregion
			filterstringy1 = filterstring+filterstringy1;
			filterstringy2 = filterstring+filterstringy2;
			filterstringy3 = filterstring+filterstringy3;

			//Debug.WriteLine("filter: "+filterstring);
			Debug.WriteLine("filtery1: "+filterstringy1);
			Debug.WriteLine("filtery2: "+filterstringy2);
			Debug.WriteLine("filtery3: "+filterstringy3);

			Session["Filterstring"] = filterstringy1;
			Session["Filterstring2"] = filterstringy2;
			Session["Filterstring3"] = filterstringy3;
			...
			switch ((int)Session["Version"])
			{
				case 20://thermistor
					...
					dvqryWaterTemperatureLoggerDetails.RowFilter = filterstringy3;
				...
				case 2://electrofishing
					...
					Debug.WriteLine("records: "+dvqryElectrofishingSites.Count.ToString());
					dvqryElectrofishingSites.RowFilter = filterstringy1;
					Debug.WriteLine("records: "+dvqryElectrofishingSites.Count.ToString());
					dg1.DataSource = dvqryElectrofishingSites;
					lbldg1Heading.Text = "Electrofishing Sites";

					qryElectrofishingMethodDetailsColumns(dg2);
					dvqryElectrofishingMethodDetails.RowFilter = filterstringy2;
					...
					dvqryElectrofishingSiteMeasurements.RowFilter = filterstringy2;
					...
					dvqryElectrofishingWaterMeasurements.RowFilter = filterstringy2;
					...
					dvqryElectrofishingDataPlusEstimates.RowFilter = filterstringy2;
					...
					dvqryElectrofishingMarkRecaptureDataPlusEstimates.RowFilter = filterstringy2;
				...
				case 29://ESA
					...
					dvqryESAObservations.RowFilter = filterstringy2;
					...
					dvqryESAPlanning.RowFilter = filterstringy2;
		...
		protected void btndg1Download_Click(object sender, System.EventArgs e)
		{
			...
			switch ((int)Session["Version"])
			{
				case 20://thermistor
					LoadWaterTemperatureLogger();
					qryWaterTemperatureLoggerSitesColumns(dg1);
					dvqryWaterTemperatureLoggerSites.RowFilter = Session["Filterstring"].ToString();
					dg1.DataSource = dvqryWaterTemperatureLoggerSites;
					break;
				case 5://stocking
					LoadFishStocking();
					qryFishStockingSitesColumns(dg1);
					dvqryFishStockingSites.RowFilter = Session["Filterstring"].ToString();
					dg1.DataSource = dvqryFishStockingSites;
					break;
				case 2://electrofishing
					LoadElectrofishing();
					qryElectrofishingSitesColumns(dg1);
					dvqryElectrofishingSites.RowFilter = Session["Filterstring"].ToString();
					dg1.DataSource = dvqryElectrofishingSites;
					break;
				case 29://ESA
					LoadESA();
					qryESASitesColumns(dg1);
					dvqryESASites.RowFilter = Session["Filterstring"].ToString();
					dg1.DataSource = dvqryESASites;
					break;
			}
			dg1.DataBind();
		...
		protected void btndg2Download_Click(object sender, System.EventArgs e)
		{
			switch ((int)Session["Version"])
			{
				case 20://thermistor
					LoadWaterTemperatureLogger();
					qryWaterTempertureLoggerDetailsColumns(dg2);
					dvqryWaterTemperatureLoggerDetails.RowFilter = Session["Filterstring3"].ToString();
					dg2.DataSource = dvqryWaterTemperatureLoggerDetails;
					break;
				case 5://stocking
					LoadFishStocking();
					qryFishStockingColumns(dg2);
					dvqryFishStocking.RowFilter = Session["Filterstring2"].ToString();
					dg2.DataSource = dvqryFishStocking;
					break;
				case 2://electrofishing
					LoadElectrofishing();
					qryElectrofishingMethodDetailsColumns(dg2);
					dvqryElectrofishingMethodDetails.RowFilter = Session["Filterstring2"].ToString();
					dg2.DataSource = dvqryElectrofishingMethodDetails;
					break;
				case 29://ESA
					LoadESA();
					qryESASiteMeasurementsColumns(dg2);
					dvqryESASiteMeasurements.RowFilter = Session["Filterstring2"].ToString();
					dg2.DataSource = dvqryESASiteMeasurements;
					break;
			}
			dg2.DataBind();
		...
		protected void btndg3Download_Click(object sender, System.EventArgs e)
		{
			switch ((int)Session["Version"])
			{
				case 20://thermistor
					LoadWaterTemperatureLogger();
					qryWaterTempertureLoggerMeasurementsColumns(dg3);
					dvqryWaterTemperatureLoggerMeasurements.RowFilter = Session["Filterstring2"].ToString();
					dg3.DataSource = dvqryWaterTemperatureLoggerMeasurements;
					break;
				case 5://stocking
					break;
				case 2://electrofishing
					LoadElectrofishing();
					qryElectrofishingSiteMeasurementsColumns(dg3);
					dvqryElectrofishingSiteMeasurements.RowFilter = Session["Filterstring2"].ToString();
					dg3.DataSource = dvqryElectrofishingSiteMeasurements;
					break;
				case 29://ESA
					LoadESA();
					qryESAObservationsColumns(dg3);
					dvqryESAObservations.RowFilter = Session["Filterstring2"].ToString();
					dg3.DataSource = dvqryESAObservations;
					break;
			}
			dg3.DataBind();
		...
		protected void btndg4Download_Click(object sender, System.EventArgs e)
		{
			switch ((int)Session["Version"])
			{
				...
				case 2://electrofishing
					LoadElectrofishing();
					qryElectrofishingWaterMeasurementsColumns(dg4);
					dvqryElectrofishingWaterMeasurements.RowFilter = Session["Filterstring2"].ToString();
					dg4.DataSource = dvqryElectrofishingWaterMeasurements;
					break;
				case 29://ESA
					LoadESA();
					qryESAPlanningColumns(dg4);
					dvqryESAPlanning.RowFilter = Session["Filterstring2"].ToString();
					dg4.DataSource = dvqryESAPlanning;
					break;
			}
			dg4.DataBind();
		...
		protected void btndg5Download_Click(object sender, System.EventArgs e)
		{
			switch ((int)Session["Version"])
			{
				...
				case 2://electrofishing
					LoadElectrofishing();
					qryElectrofishingDataPlusEstimatesColumns(dg5);
					dvqryElectrofishingDataPlusEstimates.RowFilter = Session["Filterstring2"].ToString();
					dg5.DataSource = dvqryElectrofishingDataPlusEstimates;
					break;
				case 29://ESA
					break;
		...
		protected void btndg6Download_Click(object sender, System.EventArgs e)
		{
			switch ((int)Session["Version"])
			{
				case 20://thermistor
				...
				case 2://electrofishing
					LoadElectrofishing();
					qryElectrofishingMarkRecaptureDataPlusEstimatesColumns(dg6);
					dvqryElectrofishingMarkRecaptureDataPlusEstimates.RowFilter = Session["Filterstring2"].ToString();
					dg6.DataSource = dvqryElectrofishingMarkRecaptureDataPlusEstimates;
					break;
				case 29://ESA
					break;
		...
		#region Fill & Load
		public void FillCodeDataSet(NBADWDataEntryApplication.dsDE_Agencies dataSet1)
		{
