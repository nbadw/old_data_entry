<%@ Page language="c#" Inherits="NBADWDataEntryApplication.Download1" CodeFile="Download.aspx.cs" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<fieldset class="standardText">
				...
				<table border="0">
					...
					<tr>
						...
						<td><asp:dropdownlist id=dlstAgencyCode runat="server" DataSource="<%# objdsDE_Agencies %>" DataTextField="Agency" DataValueField="AgencyCd"></asp:dropdownlist></td>
					</tr>
					<tr>
			...
			<asp:panel id="pnldg1" runat="server" Visible="False" Wrap="False">
				...
				<asp:datagrid id="dg1" runat="server" CssClass="gridItem" AutoGenerateColumns="False" CellPadding="3"
					BorderWidth="1px" BorderColor="#CCCCCC" ShowFooter="True">
				...
				<asp:datagrid id="dg2" runat="server" CssClass="gridItem" AutoGenerateColumns="False" BorderWidth="1px"
					BorderColor="#CCCCCC" ShowFooter="True">
					<FooterStyle BackColor="LightSteelBlue"></FooterStyle>
					<ItemStyle HorizontalAlign="Center"></ItemStyle>
					<HeaderStyle Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" VerticalAlign="Bottom"
						BackColor="LightSteelBlue"></HeaderStyle>
				...
				<asp:datagrid id="dg3" runat="server" CssClass="gridItem" AutoGenerateColumns="False" CellPadding="3"
					BorderWidth="1px" BorderColor="#CCCCCC" ShowFooter="True">
					<FooterStyle BackColor="LightSteelBlue"></FooterStyle>
					<ItemStyle HorizontalAlign="Center"></ItemStyle>
					<HeaderStyle Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" VerticalAlign="Bottom"
				...
				<asp:datagrid id="dg4" runat="server" CssClass="gridItem" AutoGenerateColumns="False" CellPadding="3"
					BorderWidth="1px" BorderColor="#CCCCCC" ShowFooter="True">
					<FooterStyle BackColor="LightSteelBlue"></FooterStyle>
					<ItemStyle HorizontalAlign="Center"></ItemStyle>
					<HeaderStyle Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" VerticalAlign="Bottom"
				...
				<asp:datagrid id="dg5" runat="server" CssClass="gridItem" AutoGenerateColumns="False" CellPadding="3"
					BorderWidth="1px" BorderColor="#CCCCCC" ShowFooter="True">
					<FooterStyle BackColor="LightSteelBlue"></FooterStyle>
					<ItemStyle HorizontalAlign="Center"></ItemStyle>
					<HeaderStyle Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" VerticalAlign="Bottom"
				...
				<asp:datagrid id="dg6" runat="server" CssClass="gridItem" AutoGenerateColumns="False" CellPadding="3"
					BorderWidth="1px" BorderColor="#CCCCCC" ShowFooter="True">
					<FooterStyle BackColor="LightSteelBlue"></FooterStyle>
					<ItemStyle HorizontalAlign="Center"></ItemStyle>
					<HeaderStyle Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" VerticalAlign="Bottom"
				...
				<asp:Button id="btndg6Download" runat="server" Text="Download" onclick="btndg6Download_Click"></asp:Button>
			</asp:panel></form>
	</body>
</HTML>
